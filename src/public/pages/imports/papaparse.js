...
(function(root, factory) {
  ...
  if (typeof define === "function" && define.amd) {
    ...
    console.log("Setting Papa factory to define (amd)");
    define([], factory);
  } else if (typeof module === "object" && typeof exports !== "undefined") {
    // Node. Does not work with strict CommonJS, but
    // only CommonJS-like environments that support module.exports,
    // like Node.
    console.log("Setting Papa factory to module.exports");
    module.exports = factory();
  } else {
    // Browser globals (root is window)
    console.log("Setting Papa factory to window object. root param = ");
    console.log(root);
    root.Papa = factory();
  }
})(window, function() {
  ...
  if (global.jQuery) {
    console.log("Papa is using jQuery");
    var $ = global.jQuery;
  ...
  function JsonToCsv(_input, _config) {
    ...
    if (_input instanceof Array) {
      ...
      if (_input.data instanceof Array) {
        ...
        if (!_input.fields)
          _input.fields =
            _input.data[0] instanceof Array ? _input.fields : objectKeys(_input.data[0]);
